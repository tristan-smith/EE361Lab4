...
The noise power of the signal was very low, at around -57 dB \ref{kugs-table} which allowed us to effectively ignore the noise when doing any calculations having to do with received signal power.
